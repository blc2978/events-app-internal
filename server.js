...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool', location: 'that place', time: 'that time'},
        { title: 'another event', id: 2, description: 'something even cooler', location: 'the place', time: 'the time' }
    ]
};
